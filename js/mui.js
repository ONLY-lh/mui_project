...
(function($, window, document) {
    ...
    var createInput = function(placeholder) {
        return '\
        	<div class="' + CLASS_POPUP_INPUT + '">\
        		<input type="text" autofocus placeholder="' + (placeholder || '') + '"/>\
        	</div>\
        ';
    };
    var createTwoInput = function(placeholder1, placeholder2) {
        return '\
        	<div class="' + CLASS_POPUP_INPUT + '">\
    ...
    var createThreeInput = function(placeholder1, placeholder2, placeholder3) {
        return '\
        	<div class="' + CLASS_POPUP_INPUT + '">\
        		<input type="text" placeholder="' + placeholder1 + '"/>\
        		<input type="text" placeholder="' + placeholder2 + '"/>\
    ...
    var createInputAndButton = function(placeholder, buttonName) {
        return '\
        	<div class="' + CLASS_POPUP_INPUT + '">\
        		<input type="text" placeholder="' + placeholder + '"/>\
        		<input type="button" id="resetPassword" value="' + buttonName + '"/>\
        	</div>\
        ';
    };
    var createInner = function(message, title, extra) {
        return '\
        	<div class="' + CLASS_POPUP_INNER + '">\
        		<div class="' + CLASS_POPUP_TITLE + '">' + title + '</div>\
    ...
    var createPrompt = function(message, placeholder, title, btnArray, callback, type) {
        ...
        if (!$.os.plus || type === 'div') {
            return createPopup(createInner(message, title || '提示', createInput(placeholder)) + createButtons(btnArray || ['取消', '取消']), callback);
        }
        return plus.nativeUI.prompt(message, callback, title || '提示', placeholder, btnArray || ['取消', '确认']);
    };
    var createPrompt_setPassword = function(message, title, placeholder1, placeholder2, btnArray, callback, type) {
        if (!$.os.plus || type === 'div') {
            return createPopup(createInner(message, title, createTwoInput(placeholder1, placeholder2)) + createButtons(btnArray || ['确认', '取消']), callback);
        }
    }
    var createPrompt_inputPassword = function(message, title, placeholder, buttonName, btnArray, callback, type) {
        if (!$.os.plus || type === 'div') {
            return createPopup(createInner(message, title, createInputAndButton(placeholder, buttonName)) + createButtons(btnArray || ['确认', '取消']), callback);
        }
    }
    var createPrompt_resetPassword = function(message, title, placeholder1, placeholder2, placeholder3, btnArray, callback, type) {
        if (!$.os.plus || type === 'div') {
            return createPopup(createInner(message, title, createThreeInput(placeholder1, placeholder2, placeholder3)) + createButtons(btnArray || ['确认', '取消']), callback);
        }
    }
    ...
    $.prompt = createPrompt;
    $.prompt_setPassword = createPrompt_setPassword;
    $.prompt_inputPassword = createPrompt_inputPassword;
    $.prompt_resetPassword = createPrompt_resetPassword;
})(mui, window, document);
(function($, document) {
